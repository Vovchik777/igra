...
def screen_draw():
    ...
    if scene == 'configure_game':
        ...
        menu_cofigure_bot.move(screen.get_width()//2 - menu_cofigure_bot.get_width()//2, screen.get_height()//3-menu_cofigure_bot.get_height()-100)
        ...
        button_start_game.move(screen.get_width()//2 - button_start_game.get_width()//2,screen.get_height()//2+button_start_game.get_height())
        if max:
